...
<head>
    ...
    <title>Articles | Louis MOULINET</title>
    <link
    ...
    <main class="pt-32 pb-20 px-8 md:px-12 max-w-7xl">
        ...
        <header class="mb-20">
            <div class="veille-hero-tag">
                <span class="hero-tag">SELECT Articles FROM Veille;</span>
        ...
        <section class="rounded-1xl glass-surface p-3 pt-4 small-glass">
            ...
            <div class="space-y-6 rounded-1xl grid grid-cols-1 md:grid-cols-3 gap-4" id="articles-container">
                <!-- Populated by JS -->
            </div>
        </section>
    </main>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            veilleData.forEach((article, index) => {
                ...
                if (!link) {
                    // we do not do anything because we only display articles
